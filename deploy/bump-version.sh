...
# pull a list of CHANGELOG from git history, prepend this to
...
if [ -f VERSION ]; then
    ...
    #git tag -f -a -m "Tagging version $INPUT_STRING" "v$INPUT_STRING"
    ...
    if [ "$RESPONSE" = "y" ]; then
        ...
        git commit -m "Added VERSION and CHANGELOG files"
